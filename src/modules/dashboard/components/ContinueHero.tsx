    ...
    <div className="mb-6 flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] sm:text-[11px] text-muted line-clamp-2 mt-0.5 leading-snug">
                {lang === "en"
                  ? "Grammar & particles reference."
                  : "Referensi tata bahasa & partikel."}
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] sm:text-[11px] text-muted line-clamp-2 mt-0.5 leading-snug">
                {lang === "en"
                  ? "Verb conjugation practice & SRS."
                  : "Latihan konjugasi kata kerja & SRS."}
              </p>
            </div>
          </Link>
          {/* AI Chat */}
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] sm:text-[11px] text-muted line-clamp-2 mt-0.5 leading-snug">
                {lang === "en"
                  ? "Practice conversation with Gemini AI."
                  : "Latihan percakapan dengan AI Gemini."}
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] sm:text-[11px] text-muted line-clamp-2 mt-0.5 leading-snug">
                {lang === "en"
                  ? "Practice mock exams for N5/N4/N3."
                  : "Latihan ujian mock untuk N5/N4/N3."}
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] sm:text-[11px] text-muted line-clamp-2 mt-0.5 leading-snug">
                {lang === "en"
                  ? "Search and study Japanese Kanji."
                  : "Cari dan pelajari Kanji Jepang."}
              </p>
            </div>
          </Link>
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] sm:text-[11px] text-muted line-clamp-2 mt-0.5 leading-snug">
                {lang === "en"
                  ...
                  : "Kata dan kalimat yang disimpan."}
              </p>
            </div>
          </Link>
      ...
      <div className="flex flex-wrap items-center gap-2 mt-1">
        ...
        {summary.bookmarksCount > 0 && (
          ...
          >
            🔖{" "}
            {t.dashboardBookmarks.replace(
              "{n}",
              String(summary.bookmarksCount),
            )}
          </Link>
        )}
        <a

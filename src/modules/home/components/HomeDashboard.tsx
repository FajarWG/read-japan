  ...
  const content = {
    en: {
      ...
      features: [
        ...
        {
          id: "it-kotoba",
          title: "IT Kotoba (ITの言葉)",
          subtitle: "IT/Developer Terms",
          desc: "Memorize important developer vocabulary in Japanese. Customize cards grid, toggle furigana, add custom words, and study with Anki mode.",
          route: "/it-kotoba",
          icon: "💻",
          badge: "New",
          color: "border-sky-500/20 hover:border-sky-500/60 dark:hover:bg-sky-950/10 hover:shadow-sky-500/10",
    ...
    id: {
      ...
      features: [
        ...
        },
        {
          id: "it-kotoba",
          title: "IT Kotoba (ITの言葉)",
          subtitle: "Kosakata IT/Developer",
          desc: "Hafalkan istilah-istilah IT penting dalam bahasa Jepang. Atur kolom grid, toggle furigana, tambah kata kustom, dan belajar dengan mode Anki.",
          route: "/it-kotoba",
          icon: "💻",
          badge: "Baru",
          color: "border-sky-500/20 hover:border-sky-500/60 dark:hover:bg-sky-950/10 hover:shadow-sky-500/10",

...
export const translations = {
  en: {
    ...
    // ── Brand ───────────────────────────────────────────────
    brandDesc: "Grammar, conjugation, flashcards & vocab",
    ...
    ankiGood: "Good",
    ankiEasy: "Easy",
    ankiFinishedTitle: "Session complete",
    ...
    ankiPostSettingLabel: "Progress Saving Mode",
    ankiPostSettingSession: "Save when session ends",
    ankiPostSettingCard: "Save immediately per card",
  ...
  id: {
    ...
    ankiPostSettingLabel: "Mode Penyimpanan Progres",
    ankiPostSettingSession: "Simpan setelah sesi selesai",
    ankiPostSettingCard: "Simpan langsung per jawab kartu",
